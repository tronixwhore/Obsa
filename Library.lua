...
local Library = {
    ...
    Scheme = {
        ...
        AccentColor = Color3.fromRGB(167, 167, 229),
        OutlineColor = Color3.fromRGB(29, 29, 29),
        FontColor = Color3.new(1, 1, 1),
        Font = Font.fromEnum(Enum.Font.Roboto),

        RedColor = Color3.fromRGB(167, 167, 229),
        DestructiveColor = Color3.fromRGB(220, 38, 38),
        DarkColor = Color3.new(0, 0, 0),
        WhiteColor = Color3.new(167, 167, 229),
    },
    ...
    if Data.BigIcon then
        ...
        if ParsedIcon then
            BigIconLabel = New("ImageLabel", {
                ...
                ImageColor3 = Data.IconColor or "ColorAccent",
